...
export const CATEGORIES = {
  PRESENTATION: {
    ...
    templates: [
      ...
      { id: 'p9', name: 'Lépésről lépésre folyamat', task: 'Készítsen képet egy folyamatlebontásról a(z) [TOPIC] számára, pontosan 5 világos és cselekvésközpontú szakaszra osztva.', style: 'Step-by-Step Educational Path', composition: 'Numbered sequence track', elements: 'Numbered badges, action verbs, small illustrations', palette: 'Sequential blue shades', lighting: 'Top-down clarity', goal: 'Procedurális tudás.' },
